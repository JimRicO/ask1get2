...
const Auth = () => {
      ...
      if (isSignUp) {
        const { error } = await supabase.auth.signUp({
          ...
          options: {
            ...
            emailRedirectTo: `${window.location.origin}/cellar`,
          },
        });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-wine-cream to-background p-4">
